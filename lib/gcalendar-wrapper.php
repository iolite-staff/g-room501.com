 ...
 */
$calColorBgDark      = '#ffe5ac';	// dark background color
$calColorTextOnDark  = '#ffffff';	// text appearing on top of dark bg color
$calColorBgLight     = '#fff4db';	// light background color
$calColorTextOnLight = '#480e09';	// text appearing on top of light bg color
$calColorBgToday     = '#ffe9e8';	// background color for "today" box
...
#nav .nav-buttons a {
	background-color:{$calColorTextOnLight} !important;
}
