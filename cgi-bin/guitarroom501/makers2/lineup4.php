    ...
    <td width="8">&nbsp;</td>
      <td colspan="2" align="center" valign="middle"><br>
        <table width="610" border="0" cellpadding="0" cellspacing="8">
          <tr> 
            <td colspan="4"> <span class="title">12FRET</span></td>
          </tr>
          <tr> 
            <td width="300" colspan="2" rowspan="4"><img src="<?=DATPATH2?>makers/<?=$_GET['maker']?>/line4_0.jpg" alt="" name="GuitarImagew" width="240" height="393" style="background-color: #FFFFFF"><br> 
              <div align="center"><span class="model">OOO-2H</span> </div></td>
            <td colspan="2" valign="top"><span class="title">12FRET</span><br> 
              <span class="profile">
伝統的で美しいスロッテッドヘッドからインスパイアされた12フレットジョイント・シリーズは、1920年代を彷彿させ、その甘い繊細なサウンドは独創的なプレイヤーを刺激させます。
また12フレットジョイントのドレッドノートであるDS-2Hは、通常のドレッドノートより太く豊かに響き、パワフルに響きます。</span></td>
          </tr>
          <tr> 
            <td colspan="2" valign="top"><span class="title">LineUp</span><br> 
              <li>OO-2H OOsize 12 Fret Joint</li>
              <li>OOO-2H OOOsize 12 Fret Joint</li>
              <li>DS-2H 12 Fret joint Dreadnought</li></td>
          </tr>
          <tr> 
            <td colspan="2" align="left" valign="top" class="title">Dimensions(OOO-2H)<br> 
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="title">Dimensions(DS-2H)<br> 
              <table width="300" border="0" cellspacing="0" cellpadding="0">
                <tr class="text"> 
                  <td align="right" width="100"> Nut Width：</td>
                  <td>1 13/16&quot;(46mm)</td>
          ...
          <tr align="center" valign="top"> 
            <td width="150"><br>
              <img src="<?=DATPATH2?>makers/<?=$_GET['maker']?>/line4_1.jpg" alt="" width="120" height="175" style="border: 1px solid #999999;"><br>
              <span class="model">DS-2H</span> </td>
            <td width="150"> <img src="<?=DATPATH2?>makers/<?=$_GET['maker']?>/line4_2.jpg" alt="" width="120" height="160" style="border: 1px solid #999999;"><br>
              <span class="model">Slotted Head</span> </td>
            <td width="150"><br> <br> <br>
              <img src="<?=DATPATH2?>makers/<?=$_GET['maker']?>/line4_3.jpg" alt="" width="120" height="160" style="border: 1px solid #999999;"><br>
              <span class="model">Pyramid Bridge</span> </td>
