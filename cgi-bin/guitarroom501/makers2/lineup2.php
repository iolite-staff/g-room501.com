...
<table width="640" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#cccccc">
    <td width="8">&nbsp;</td>
      <td width="610" colspan="2" align="center" valign="middle"><br>
        <table width="610" border="0" cellpadding="0" cellspacing="8">
          ...
          <tr> 
            ...
            <td colspan="2" valign="top"><span class="title">Dreadnoughts</span><br>
              <span class="profile">
プリウォーのドレッドノート・スタイルを基準に、細部にわたりコリングス流のアレンジを加えて完成したＤシリーズ。
ドレッドノートに要求されるパワフルさは勿論のことながら、プリウォー・タイプのスキャロップド・ブレイシング（アドバンスＸパターン）の採用により各弦の輪郭がより際だつサウンド、タイトな鳴りの良さも併せ持っておりそのパワフルなサウンドはあらゆるシーンに対応します。</span></td>
          </tr>
          <tr> 
            <td colspan="2" valign="top"><span class="title">LineUp</span><br> 
              <li>D1（Mahogany Side&Back）</li>
              <li>D2H（IndianRosewood Side&Back）</li>
              <li>D3（Abalone Rossete）</li></td>
          </tr>
          <tr> 
