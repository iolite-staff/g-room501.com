        ...
        <table width="610" border="0" cellpadding="0" cellspacing="8">
          ...
          <tr> 
            ...
            <td colspan="2" valign="top"><span class="title">OM</span><br>
              <span class="profile">
1929～33年という僅かな期間した作られなかった14フレットジョイントでOOOサイズのボディを持つオーケストラモデルを完璧にまで再現しました。
プリウォーOMに求められるマテリアルを忠実に満たした上で、新品でありながら枯れたオールドフレーバー溢れるサウンドは、まさにコリングスを代表するモデルです。</span></td>
          </tr>
          <tr> 
