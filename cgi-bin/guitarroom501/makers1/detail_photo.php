...
require_once('../inc/h_common.inc');
	...
	//データファイルパスのセット
	$path = DATPATH."makers/".$get['maker']."/coming/".$get['cd'].".txt";
...
*/
	...
	if(isset($get['front'])){
		//画像ファイルチェック（FRONT）
		if(file_exists(DATPATH."makers/".$get['maker']."/coming/".$get['cd']."_front.jpg")){
			$imgpath = "<img src=\"".DATPATH2."makers/".$get['maker']."/coming/".$get['cd']."_front.jpg\">";
		}else{
			$imgpath = "";
		}
	}elseif(isset($get['back'])){
		//画像ファイルチェック（BACK）
		if(file_exists(DATPATH."makers/".$get['maker']."/coming/".$get['cd']."_back.jpg")){
			$imgpath = "<img src=\"".DATPATH2."makers/".$get['maker']."/coming/".$get['cd']."_back.jpg\">";
		}else{
			$imgpath = "";
		}
	}elseif(isset($get['case'])){
		//画像ファイルチェック（BACK）
		if(file_exists(DATPATH."makers/".$get['maker']."/coming/".$get['cd']."_case.jpg")){
			$imgpath = "<img src=\"".DATPATH2."makers/".$get['maker']."/coming/".$get['cd']."_case.jpg\">";
		}else{
			$imgpath = "";
		}
	}elseif(isset($get['part'])){
		//画像ファイルチェック（パーツ）
		if(file_exists(DATPATH."makers/".$get['maker']."/coming/".$get['cd']."_part".$get['part'].".jpg")){
			$imgpath = "<img src=\"".DATPATH2."makers/".$get['maker']."/coming/".$get['cd']."_part".$get['part'].".jpg\">";
		}else{
			$imgpath = "";
		}
	}else{
		//画像ファイルチェック（特殊）
		if(file_exists(DATPATH."makers/".$get['maker']."/coming/".$get['cd']."_special".$get['special'].".jpg")){
			$imgpath = "<img src=\"".DATPATH2."makers/".$get['maker']."/coming/".$get['cd']."_special".$get['special'].".jpg\">";
		}else{
			$imgpath = "";
		}
	}
...
<div align="center">
  <table width="640" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="8" height="4" background="<?=IMGPATH?>bg_top.gif"><font size="1"><img src="<?=IMGPATH?>clear.gif" width="7" height="7"></font></td>
      <td width="130" height="4" background="<?=IMGPATH?>bg_top.gif"><font size="1"><img src="<?=IMGPATH?>clear.gif" width="7" height="7"></font></td>
      <td width="494" height="4" align="right" background="<?=IMGPATH?>bg_top.gif"><font size="1"><img src="<?=IMGPATH?>clear.gif" width="7" height="7"></font></td>
      <td width="8" align="right" background="<?=IMGPATH?>bg_right_side.gif"><font size="1"><img src="<?=IMGPATH?>clear.gif" width="7" height="7"></font></td>
    </tr>
    <tr>
      <td width="8" background="<?=IMGPATH?>bg_left_side.gif">&nbsp;</td>
      <td colspan="2" align="center" valign="middle" background="<?=IMGPATH?>bg_sand.gif"><font color="#660033" size="2">&nbsp;</font><font color="#660033" size="2">&nbsp;</font>
...
*/?>
      ...
      <td width="8" align="right" background="<?=IMGPATH?>bg_right_side.gif">&nbsp;</td>
    </tr>
      <TR>
        <TD valign="center" align="middle" background="<?=IMGPATH?>bg_yabure5_r.gif" colSpan="3">&nbsp; </TD>
      </TR>
  </table>
</div>
