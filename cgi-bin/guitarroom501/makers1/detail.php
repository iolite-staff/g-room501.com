...
require_once('../inc/h_common.inc');
	...
	//データファイルパスのセット
	$path = DATPATH."makers/".$_GET['maker']."/coming/".$_GET['cd'].".txt";
	...
	//画像ファイルチェック（FRONT）
	if(file_exists(DATPATH."makers/".$_GET['maker']."/coming/".$_GET['cd']."_front_s.jpg")){
		$imgpath_front = "<img src=\"".DATPATH2."makers/".$_GET['maker']."/coming/".$_GET['cd']."_front_s.jpg\">";
	}else{
		$imgpath_front = "";
	}

	//画像ファイルチェック（BACK）
	if(file_exists(DATPATH."makers/".$_GET['maker']."/coming/".$_GET['cd']."_back_s.jpg")){
		$imgpath_back = "<img src=\"".DATPATH2."makers/".$_GET['maker']."/coming/".$_GET['cd']."_back_s.jpg\">";
	}else{
		$imgpath_back = "";
	}
...
?>
        ...
        <tr>
          <td width="160"><font color="#660033" size="1">拡大して見たい部分（<font color="#CC0000"><strong>○</strong><font color="#660033">部分）<br>
            ...
            <?php
		//画像ファイルチェック（特殊１）
		if(file_exists(DATPATH."makers/".$_GET['maker']."/coming/".$_GET['cd']."_special1.jpg")){
			print("<a href=\"detail_photo.php?maker=".$_GET['maker']."&cd=".$_GET['cd']."&special=1\" target=\"_blank\">特別写真１</a><br>\n");
		}
		//画像ファイルチェック（特殊２）
		if(file_exists(DATPATH."makers/".$_GET['maker']."/coming/".$_GET['cd']."_special2.jpg")){
			print("<a href=\"detail_photo.php?maker=".$_GET['maker']."&cd=".$_GET['cd']."&special=2\" target=\"_blank\">特別写真２</a><br>\n");
		}
		//画像ファイルチェック（特殊３）
		if(file_exists(DATPATH."makers/".$_GET['maker']."/coming/".$_GET['cd']."_special3.jpg")){
			print("<a href=\"detail_photo.php?maker=".$_GET['maker']."&cd=".$_GET['cd']."&special=3\" target=\"_blank\">特別写真３</a><br>\n");
		}
		//画像ファイルチェック（特殊４）
		if(file_exists(DATPATH."makers/".$_GET['maker']."/coming/".$_GET['cd']."_special4.jpg")){
...
?>
    ...
    background="<?=IMGPATH?>bg_yabure5_r.gif" colSpan=2>&nbsp; </TD>
