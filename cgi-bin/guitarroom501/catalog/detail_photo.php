...
require_once('../inc/h_common.inc');
	...
	//データファイルパスのセット
	$path = DATPATH."guitar/".$get['maker']."/".$get['cd'].".txt";
...
*/
	...
	if(isset($get['front'])){
		//画像ファイルチェック（FRONT）
		if(file_exists(DATPATH."guitar/".$get['maker']."/".$get['cd']."_front.jpg")){
			$imgpath = "<img src=\"".DATPATH2."guitar/".$get['maker']."/".$get['cd']."_front.jpg\">";
		}else{
			$imgpath = "";
		}
	}elseif(isset($get['back'])){
		//画像ファイルチェック（BACK）
		if(file_exists(DATPATH."guitar/".$get['maker']."/".$get['cd']."_back.jpg")){
			$imgpath = "<img src=\"".DATPATH2."guitar/".$get['maker']."/".$get['cd']."_back.jpg\">";
		}else{
			$imgpath = "";
		}
	}elseif(isset($get['case'])){
		//画像ファイルチェック（BACK）
		if(file_exists(DATPATH."guitar/".$get['maker']."/".$get['cd']."_case.jpg")){
			$imgpath = "<img src=\"".DATPATH2."guitar/".$get['maker']."/".$get['cd']."_case.jpg\">";
		}else{
			$imgpath = "";
		}
	}elseif(isset($get['part'])){
		//画像ファイルチェック（パーツ）
		if(file_exists(DATPATH."guitar/".$get['maker']."/".$get['cd']."_part".$get['part'].".jpg")){
			$imgpath = "<img src=\"".DATPATH2."guitar/".$get['maker']."/".$get['cd']."_part".$get['part'].".jpg\">";
		}else{
			$imgpath = "";
		}
	}else{
		//画像ファイルチェック（特殊）
		if(file_exists(DATPATH."guitar/".$get['maker']."/".$get['cd']."_special".$get['special'].".jpg")){
			$imgpath = "<img src=\"".DATPATH2."guitar/".$get['maker']."/".$get['cd']."_special".$get['special'].".jpg\">";
		}else{
			$imgpath = "";
		}
	}
