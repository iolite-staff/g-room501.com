...
<p align="center"><strong><font color="#FF0000" size="2">＜FurchGuitar編集中＞</font></strong></p>
...
<?=$msg?>
  <div align="center">
    <form name="frmMakers" method="post" action="makers0.php?maker=<?=$maker?>" enctype="multipart/form-data">
...
<form name="Delete2" method="post" action="makers0.php?maker=<?=$get['maker']?>&">
...
<hr>
<br>
<form name="no_sel" method="get" action="makers0.php" enctype="multipart/form-data">
  <div align="center">
    <select name="no">
<?php
...
<p>
  <div align="center">
    <form name="Update" method="post" enctype="multipart/form-data" action="makers0.php?maker=<?=$get['maker']?>&no=<?=$no?>">
    <table width="680" border="0" cellspacing="0" cellpadding="3">
      <tr bordercolor="#FFFFFF" bgcolor="#000000">
...
<form name="Delete" method="post" action="makers0.php?maker=<?=$get['maker']?>&">
<input name="kill" type="hidden" value="">
</form>
<form name="photoDelete" method="post" action="makers0.php?maker=<?=$get['maker']?>&">
