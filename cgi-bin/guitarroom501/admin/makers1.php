...
// add maruyama 160622 to
	...
	if(isset($dat[1])){
		...
		if($file[50] != ""){
			//拡大 ギターケースアップロード
			$path = DATPATH."makers/".$get['maker']."/".$no."_detail1.jpg";
			copy($file[50], $path);
			$msg .= $file[50]."=> ".$path." 書き換え成功しました。<BR>\n";
		}
		if($file[51] != ""){
			//拡大 ギターケースアップロード
			$path = DATPATH."makers/".$get['maker']."/".$no."_detail2.jpg";
			copy($file[51], $path);
			$msg .= $file[51]."=> ".$path." 書き換え成功しました。<BR>\n";
		}
		if($file[52] != ""){
			//拡大 ギターケースアップロード
			$path = DATPATH."makers/".$get['maker']."/".$no."_detail3.jpg";
			copy($file[52], $path);
			$msg .= $file[52]."=> ".$path." 書き換え成功しました。<BR>\n";
		}
		if($file[53] != ""){
			//拡大 ギターケースアップロード
			$path = DATPATH."makers/".$get['maker']."/".$no."_detail4.jpg";
			copy($file[53], $path);
			$msg .= $file[53]."=> ".$path." 書き換え成功しました。<BR>\n";
		}
		//更新日付の更新
		update_day();
	}
	...
	if(isset($post['kill'])){
		...
		$path = DATPATH."makers/".$get['maker']."/".$no."_detail1.jpg";
		@unlink($path);
		$msg .= $no." 詳細写真1削除成功しました。<BR>\n";
		//ギター詳細写真削除
		$path = DATPATH."makers/".$get['maker']."/".$no."_detail2.jpg";
		@unlink($path);
		$msg .= $no." 詳細写真2削除成功しました。<BR>\n";
		//ギター詳細写真削除
		$path = DATPATH."makers/".$get['maker']."/".$no."_detail3.jpg";
		@unlink($path);
		$msg .= $no." 詳細写真3削除成功しました。<BR>\n";
		//ギター詳細写真削除
		$path = DATPATH."makers/".$get['maker']."/".$no."_detail4.jpg";
		@unlink($path);
		$msg .= $no." 詳細写真4削除成功しました。<BR>\n";
		//更新日付の更新
		update_day();
	}
...
<p align="center"><strong><font color="#FF0000" size="2">＜Sumi工房編集中＞</font></strong></p>
  ...
  <div align="center">
    ...
    <table width="680" border="0" cellspacing="0" cellpadding="3">
      <tr bordercolor="#FFFFFF" bgcolor="#000000">
        <td width="615" align="left"><strong><font size="2" color="#FFFFFF">＃<?=$makerdat[0]?> の削除</font></strong><font size="2" color="#FFFFFF">　※削除した情報は元には戻せません。</font></td>
        <td width="53">
      ...
      <tr bordercolor="#FFFFFF" bgcolor="#43888a">
        <td width="615" align="left"><strong><font size="2" color="#FFFFFF">＃<?=$makerdat[0]?>
    ...
    <table width="680" border="0" align="center" cellpadding="2" cellspacing="1" bordercolor="#FFFFFF" background="<?=IMGPATH?>bg_sand.gif">
	  ...
	  <tr>
        <td width="90" bgcolor="#43888a">
          <div align="center"><strong><font color="#FFFFFF" size="2">メーカー名<br>タイトル1</font></strong></div>
        </td>
        <td width="570" align="left">
          <input type="text" name="maker_dat[0]" size="40" maxlength="32" value="<?=$maker_title[1]?>">
        </td>
      </tr>
      <tr>
        <td bgcolor="#43888a">
          <div align="center"><strong><font size="2" color="#FFFFFF">本文1</font></strong></div>
        </td>
        <td>
          <textarea name="maker_text1" cols="80" rows="10">
<?=$maker_text[1]?>
</textarea>
      ...
      <tr>
        <td bgcolor="#43888a">
          <div align="center"><strong><font size="2" color="#FFFFFF">画像1</font></strong></div>
        </td>
        <td align="left">
          <input type="file" name="maker_file[1]" size="30" maxlength="255">
        </td>
      </tr>
	  -->
<?php
...
<?php /*20050711 S.Sato Makersにはいらない*/?>
...
<?=$txt?>
      ...
      <tr>
        <td bgcolor="<?=$bgcolor?>">
          <div align="center"><strong><font size="2" color="#FFFFFF">詳細写真1</font></strong></div>
        </td>
        <td align="left">
          <input type="file" name="file[50]" size="30" maxlength="255"><font size="2"> ※横600 × 縦450以下</font>
        </td>
      </tr>
      <!--<tr>
        <td bgcolor="<?=$bgcolor?>">
          <div align="center"><strong><font size="2" color="#FFFFFF">詳細写真2</font></strong></div>
        </td>
        <td align="left">
          <input type="file" name="file[51]" size="30" maxlength="255"><font size="2"> ※横*00 × 縦*00</font>
        </td>
      </tr>
      <tr>
        <td bgcolor="<?=$bgcolor?>">
          <div align="center"><strong><font size="2" color="#FFFFFF">詳細写真3</font></strong></div>
        </td>
        <td align="left">
          <input type="file" name="file[52]" size="30" maxlength="255"><font size="2"> ※横*00 × 縦*00</font>
        </td>
      </tr>
      <tr>
        <td bgcolor="<?=$bgcolor?>">
          <div align="center"><strong><font size="2" color="#FFFFFF">詳細写真4</font></strong></div>
        </td>
        <td align="left">
          <input type="file" name="file[53]" size="30" maxlength="255"><font size="2"> ※横*00 × 縦*00</font>
        </td>
      </tr>-->
    </table>
    </form>
